...
class DashboardSummary extends Component<I18n> {
  render(): ReactNode {
    ...
    const cardContent: string[] = [
      t?.('group_4.card_2.content_1') ?? '',
      t?.('group_4.card_2.content_2') ?? '',
      t?.('group_4.card_2.content_3') ?? '',
      t?.('group_4.card_2.content_4') ?? ''
    ];
    ...
    return (
      <>
        <Text style={{
          marginBottom: 20
        }} variant='h3'>{t?.('group_4.title')}</Text>
        <DashboardSummaryStyled container spacing={{ xs: 2, md: 3 }}>
          <Grid item {...gridItemPros}>
            <BoxOutlineSecondary>
              <Text>{t?.('group_4.card_1.title')}</Text>
              <Text variant='h3'>0 <sup>TSC</sup></Text>
              <ButtonOutline sx={{
                margin: '0 auto',
              }}>{t?.('group_4.card_1.button_label')}</ButtonOutline>
              <Text>{t?.('group_4.card_1.content')}</Text>
              <Text variant='h3'>0 <sup>TSC</sup></Text>
              <ButtonOutline sx={{
                margin: '0 auto',
              }}>&nbsp;&nbsp;{t?.('group_4.card_1.button_label2')}&nbsp;&nbsp;</ButtonOutline>
            </BoxOutlineSecondary>
          </Grid>
          ...
          <Grid item {...gridItemPros}>
            <BoxOutlineSecondary>
              <Box className='content'>
                <Text>MIN</Text>
                <Text variant='h3'>{t?.('group_4.card_2.min')}</Text>
                <Text>MAX</Text>
                <Text variant='h3'>{t?.('group_4.card_2.max')}</Text>
              </Box>
              <Text>&nbsp;</Text>
              ...
              <ButtonOutline sx={{
                margin: '0 auto',
              }}>{t?.('group_4.card_2.button_label')}</ButtonOutline>
            </BoxOutlineSecondary>
            <Text>&nbsp;</Text>
          </Grid>
          ...
          <Grid item {...gridItemPros}>
            <BoxOutlineSecondary>
              <Box className='content'>
                <Text>{t?.('group_4.card_3.title')}</Text>
              ...
              <div style={{
                ...
                <ButtonOutline sx={{
                  margin: '0 auto',
                }}>{t?.('group_4.card_3.button_label_1')}</ButtonOutline>
                <div style={{
                  marginTop: 20
                }}></div>
                {
                  t?.('group_4.card_3.button_label_2') &&
                  <ButtonOutline sx={{
                    margin: '0 auto',
                  }}>{t?.('group_4.card_3.button_label_2')}</ButtonOutline>
                }
              </div>
            </BoxOutlineSecondary>
          </Grid>
