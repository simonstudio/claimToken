          ...
          <Grid item {...gridItemPros}>
            <BoxOutlineSecondary>
              <Box className='content'>
                <Text>MIN</Text>
                <Text variant='h3'>{BNFormat(stake_info?.Staking1_min / 1e18)} {infos?.token?.symbol}</Text>
                <Text>MAX</Text>
                <Text variant='h3'>{BNFormat(stake_info?.Staking1_max / 1e18)} {infos?.token?.symbol}</Text>
              </Box>
              <Text>&nbsp;</Text>
