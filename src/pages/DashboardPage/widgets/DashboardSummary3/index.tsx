      ...
      <>
        ...
        <DashboardSummaryStyled container spacing={{ xs: 2, md: 3 }}>
          <Grid item {...gridItemPros}>
            <BoxOutlineSecondary>
              <Text>{t?.('group_3.card_1.title')}</Text>
              <Text variant='h3'>0 <sup>TSC</sup></Text>
              <ButtonOutline sx={{
                margin: '0 auto',
              }}>{t?.('group_3.card_1.button_label')}</ButtonOutline>
              <Text>{t?.('group_3.card_1.content')}</Text>
              <Text variant='h3'>0 <sup>TSC</sup></Text>
              <ButtonOutline sx={{
                margin: '0 auto',
          ...
          <Grid item {...gridItemPros}>
            <BoxOutlineSecondary>
              <Box className='content'>
                <Text>MIN</Text>
                <Text variant='h3'>{t?.('group_3.card_2.min')}</Text>
                <Text>MAX</Text>
                <Text variant='h3'>{t?.('group_3.card_2.max')}</Text>
              </Box>
              <Text>&nbsp;</Text>
              ...
              <ButtonOutline sx={{
                margin: '0 auto',
              }}>{t?.('group_3.card_2.button_label')}</ButtonOutline>
            </BoxOutlineSecondary>
            <Text>&nbsp;</Text>
          </Grid>
          ...
          <Grid item {...gridItemPros}>
            <BoxOutlineSecondary>
              ...
              <div style={{
                ...
                <ButtonOutline sx={{
                  margin: '0 auto',
                }}>{t?.('group_3.card_3.button_label_1')}</ButtonOutline>
                <div style={{
                  marginTop: 20
                }}></div>
                {
                  ...
                  <ButtonOutline sx={{
                    margin: '0 auto',
                  }}>{t?.('group_3.card_3.button_label_2')}</ButtonOutline>
                }
              </div>
            </BoxOutlineSecondary>
          </Grid>
