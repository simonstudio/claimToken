...
import banner_mobile from '../../../../assets/image/banner-mobile.webp';
      ...
      <BannerStyled theme={theme}>
        <Box className='content'>
          ...
          <Box display={'flex'} gap={3} my={3}>
            <img onClick={() => window.open("https://t.me/TimesSquareC", "_blank")} height={'42px'} src={telegram} />
            <img onClick={() => window.open("https://twitter.com/TimesSquareC", "_blank")} height={'42px'} src={twitter} />
            <img onClick={() => window.open("https://github.com/TimesSquareC", "_blank")} height={'42px'} src={github} />
          </Box>
          <WalletBox />
        </Box>
        <ButtonSecondary onClick={() => openPdfLink()} className='button' sx={{
          bottom: '9%',
          left: 0,
          right: 0,
          margin: '0 auto',
